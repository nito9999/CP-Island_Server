...
namespace ice_light_server.server_system
{
    internal class route_system
    {
        ...
        public class RouteAttribute : Attribute
        {
            ...
            public short Port { get; set; } = 0; // Port for the route
            public RouteAttribute(string path, bool isRawRegex = false, url_level priority = url_level.low, short port = 0)
            {
                Port = port;
                Path = path;
